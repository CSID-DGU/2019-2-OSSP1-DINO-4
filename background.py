...
class background:
    ...
    def background_blit(self,game):
        ...
        game.screen.blit(self.pink_up,RelRect(3440,690,80,40,game.camera))
        game.screen.blit(self.pink_up,RelRect(40,225,80,40,game.camera))
    ...
    def door_open(self,game):
        ...
        if self.timer==5 and game.item1.ate==True and game.item2.ate==True and game.item3.ate==True and game.item4.ate==True and game.item5.ate==True and game.item6.ate==True and\
            game.item7.ate==True and game.item8.ate==True and game.item9.ate==True and game.item10.ate==True and game.item11.ate==True and game.item12.ate==True:
            GAME_OVER=True
            return GAME_OVER
